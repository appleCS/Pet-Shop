...
<html>
    ...
    <body>
        ...
        <?php 
           ...
           $_SESSION["idd1"] = $_POST["iddd"];
           
          $con = new mysqli("localhost", "root", 123, "petshop", 3306);
          $setid = $con ->query("SELECT * FROM pets WHERE id='".$_SESSION["idd1"]."'");
          $selecterow = mysqli_fetch_assoc($setid);
//          $viewnic = $selecterow["seller_nic"];
          
//          $conn = new mysqli("localhost", "root", 123, "petshop", 3306);
          $user = $con->query("SELECT * from user WHERE nic ='".$selecterow["seller_nic"]."'");
        ...
        <div class="container" style="margin-top: 50px">
            <h2><?php echo $selecterow["title"]; ?></h2><br/>
            <div class="imgdiv">
                
                <img class="imgview" src="<?php echo $selecterow["imgpath"]; ?>" />
                <?php date_default_timezone_set("Asia/Colombo"); ?>
                <div class="vwuser">
                <p><?php
                   echo "posted by  " .$userrow["name"]. "<br/>"; 
                   echo $selecterow["ad_date"]; 
                   
                   ?></p>
                </div>
            </div>
            <div class="price bg-warning"><?php echo $selecterow["currency"]." ".$selecterow["price"]; ?></div>
            
            <br/><br/><br/>
            
            <div style="margin-top: -100px">  <!--Details Text Area-->
                <?php
                   echo $selecterow["description"];
                ?>
            </div>
